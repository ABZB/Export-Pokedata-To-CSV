...
flag_array = ['Contact', 'Charge', 'Recharge', 'Ignores Protect', 'Magic Bounce/Coat', 'Snatchable', 'Mirror Moveable', 'Punch', 'Sound', 'Gravity Disables', 'Defrosts User', 'Any Target Triple', 'Healing', 'Ignores Substitute', 'Fails Sky Battle', 'Animates Ally', 'Dance', 'Slicing', 'Biting', 'Bulletproof', 'Mega Launcher', 'Wind', 'Light', 'No Consecutive Use', 'Powder']

subcategories = ['Dmg', 'Inflict Status', 'Alter Stat', 'Heal', 'Dmg & Status', 'Status & Alter Stat', 'Dmg & Target Stat', 'Dmg & User Stat', 'DMG & Absorb', 'OHKO', 'Entire Field', 'One Side of Field', 'Force Target Switch', 'Unique Effect']