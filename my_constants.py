...
flag_array = ['Contact', 'Charge', 'Recharge', 'Ignores Protect', 'Magic Bounce/Coat', 'Snatchable', 'Mirror Moveable', 'Punch', 'Sound', 'Gravity Disables', 'Defrosts User', 'Any Target Triple', 'Healing', 'Ignores Substitute', 'Fails Sky Battle', 'Animates Ally', 'Dance', 'Slicing', 'Biting', 'Bulletproof', 'Mega Launcher', 'Wind', 'Light', 'No Consecutive Use']
